        ...
        <div class="container-fluid">
            <div class="row featurette">
                <div class="col-md-7">
                    ...
                    <p class="lead">
                        The stream of words is then read for information that
                        looks like receipt information and a receipt entry is
                        created in the database for you to view anytime!
                    </p>
                </div>
