    ...
    <div class="container-fluid">
      <div class="row featurette">
        <div class="col-md-7">
          ...
          <p class="lead">
            Ribbon Receipts is a online app that helps you store and categorize
            your receipts
          </p>

          <p class="lead">
            You can upload an image of a receipt and then associate a category
            and a cost with the receipt. This will be stored for so you can
