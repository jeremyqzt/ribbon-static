        ...
        <div class="container-fluid">
            <div class="row featurette">
                ...
                <div class="col-md-7">
                    ...
                    <p class="lead">
                        Once text is extracted, keywords that are common in receipts are picked out as potential canidates for
                        receipt information and then presented back to you. You can change these fields or leave them as is!
                    </p>
                </div>
            </div>
        </div>
